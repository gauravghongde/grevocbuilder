...
#
# Created: Sat Oct 14 11:55:11 2017
...
"background-color: rgba(255, 255, 255, 0);"))
        ...
        self.label_2.setPixmap(QtGui.QPixmap(_fromUtf8("../PROJtemp/icons8-User-48.png")))
...
"background-color: rgba(255, 255, 255, 0);"))
        ...
        self.label_3.setPixmap(QtGui.QPixmap(_fromUtf8("../PROJtemp/icons8-Lock-26.png")))
    ...
    def btnLoginClicked(self):
        if self.txtUsername.text()=="" or self.txtPassword.text()=="":
            ...
            if rows == None:#checking if LOGINID is present or not
                ...
                self.ui.setupUi(self.MainWindow,self.lw)
